...
export const translations = {
  ar: {
    ...
    shipment: {
      ...
      advisoryPrice: "السعر الاسترشادي", yourMaxOffer: "عرضك الأعلى",
      customerMaxOffer: "عرض العميل الأعلى",
      advisoryHint: "سعر تقديري تلقائي — يمكنك ضبط الحد الأعلى الذي تقبل تلقّي العروض ضمنه",
      pricingSelectFirst: "اختر نوع المركبة وحدّد الموقعين لعرض السعر الاسترشادي",
    ...
    bid: {
      ...
      maxOfferHint: "الحد الأعلى لعرض العميل",
      exceedsMaxOffer: "قيمة العرض تتجاوز الحد الأعلى الذي حدده العميل",
  ...
  en: {
    ...
    shipment: {
      ...
      advisoryPrice: "Advisory price", yourMaxOffer: "Your maximum offer",
      customerMaxOffer: "Customer maximum offer",
      advisoryHint: "Auto-estimated price — set the maximum you're willing to receive offers within",
      pricingSelectFirst: "Select a vehicle type and both locations to see the advisory price",
    ...
    bid: {
      ...
      maxOfferHint: "Customer maximum offer",
      exceedsMaxOffer: "Your bid exceeds the maximum offer set by the customer",
