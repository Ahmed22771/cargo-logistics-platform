...
export const translations = {
  ar: {
    ...
    nav: {
      ...
      finance: "الإدارةالمالية", access: "الصلاحيات والأدوار", disputes: "النزاعات",contracts: "العقود والمنافسات",
      operations: "مركز العمليات", settings: "الإعدادات", tracking: "التتبع",
    },
        adminContracts: {
      title: "العقود والمنافسات",
      newContract: "عقد جديد",
      back: "العودة إلى العقود",
      refresh: "تحديث",
      loading: "جاري تحميل تفاصيل العقد...",
      loadError: "تعذر تحميل العقد",
      retry: "إعادة المحاولة",
      pickupRequired: "موقع الاستلام مطلوب",
      deliveryRequired: "موقع التسليم مطلوب",
      createError: "تعذر إنشاء العقد",
      executionDates: "مواعيد التنفيذ",

      publish: "نشر العقد",
      startReview: "بدء المراجعة",
      cancel: "إلغاء العقد",
      confirmCancel: "هل أنت متأكد من إلغاء هذا العقد؟",

      contractData: "بيانات العقد",
      lots: "المنافسات الجزئية",
      bids: "عروض شركات النقل",
      awards: "الترسيات",
      documents: "مستندات العقد",

      noLots: "لا توجد منافسات جزئية لهذا العقد.",
      noBids: "لا توجد عروض مقدمة حتى الآن.",
      noAwards: "لا توجد ترسيات لهذا العقد حتى الآن.",
      noDocuments: "لا توجد مستندات مرتبطة بالعقد حاليًا.",
      ...
      currency: "العملة",
      quantity: "الكمية",
      targetPrice: "القيمة المستهدفة",
      biddingDeadline: "إغلاق المنافسة",
      startDate: "بداية التنفيذ",
      endDate: "نهاية التنفيذ",
      pickup: "الاستلام",
      delivery: "التسليم",
      description: "وصف العقد",
      instructions: "التعليمات الخاصة",
      terms: "الشروط والأحكام",

      createdAt: "تاريخ الإنشاء",
      totalUnits: "إجمالي الوحدات",
      totalBids: "العروض المقدمة",
      totalLotQuantity: "إجمالي الكميات",
      totalBidValue: "إجمالي قيمة العروض",

      company: "الشركة",
      lot: "المنافسة",
      fullContract: "العقد الكامل",
      unitPrice: "سعر الوحدة",
      totalPrice: "الإجمالي",
      executionDays: "مدة التنفيذ",
      descriptionShort: "الوصف",
      awardValue: "القيمة",
      date: "التاريخ",
      ...
      modeFull: "العقد الكامل",
      modeSplit: "عقد مقسم إلى منافسات",

      status: {
        DRAFT: "مسودة",
        PUBLISHED: "منشور",
        BIDDING: "قيد المنافسة",
      ...
      messages: {
        publishSuccess: "تم نشر العقد وفتحه للمنافسة.",
        reviewSuccess: "تم نقل العقد إلى مرحلة المراجعة.",
        cancelSuccess: "تم إلغاء العقد.",
        bidReviewSuccess: "تم تحديث حالة العرض.",
        shortlistSuccess: "تم اختيار العرض للقائمة المختصرة.",
        rejectSuccess: "تم رفض العرض.",
      },
            pageSubtitle: "إدارة العقود التجارية وطرحها للمنافسة ومتابعة العروض والترسية.",
      close: "إغلاق",
      search: "بحث",
      searchPlaceholder: "رقم العقد أو الاسم أو العميل",
      allStatuses: "كل الحالات",
      unlinked: "غير مرتبط",
      details: "التفاصيل",
      totalContracts: "إجمالي العقود",
      loadingList: "جاري تحميل العقود...",
      emptyList: "لا توجد عقود حتى الآن",

      createTitle: "إنشاء عقد جديد",
      draftNotice: "سيُنشأ العقد كمسودة ولن يصبح متاحًا للشركات حتى نشره.",

      contractTitle: "اسم العقد",
      contractNumberLabel: "رقم العقد",
      contractNumberPlaceholder: "يُولّد تلقائيًا عند تركه فارغًا",
      customerName: "اسم الشركة / العميل",
      customerId: "معرف العميل (اختياري)",
      competitionMethod: "طريقة المنافسة",
      unitsLabel: "عدد الوحدات",
      unitTypePlaceholder: "حاوية، شحنة، حمولة...",
      shipmentType: "نوع الشحنة",
      requiredCapacity: "السعة المطلوبة",
      targetContractValue: "القيمة المستهدفة للعقد",
      executionStart: "تاريخ بداية التنفيذ",
      executionEnd: "تاريخ نهاية التنفيذ",
      biddingDeadlineLabel: "آخر موعد لتقديم العروض",
      contractDescription: "وصف العقد",
      specialInstructions: "تعليمات خاصة",
      contractTerms: "الشروط",
      saving: "جاري الحفظ...",
      saveDraft: "حفظ كمسودة",

      nameRequired: "اسم العقد مطلوب",
      unitsPositive: "عدد الوحدات يجب أن يكون أكبر من صفر",
      createSuccess: "تم إنشاء العقد بنجاح",

      titleLabel: "اسم العقد",
      customerLabel: "العميل / الشركة",
      typeLabel: "النوع",
      unitsTable: "الوحدات",
      offersLabel: "العروض",
      statusLabel: "الحالة",
  ...
  en: {
    ...
    nav: {
      ...
      finance: "Finance", access: "Access & Roles", disputes: "Disputes",contracts: "Contracts & Competition",
      operations: "Operations Center", settings: "Settings", tracking: "Tracking",
    },
        adminContracts: {
      title: "Contracts & Competition",
      ...
      lots: "Contract Lots",
      bids: "Transport Provider Bids",
      awards: "Awards",
      documents: "Contract Documents",

      noLots: "No lots exist for this contract.",
      noBids: "No bids have been submitted yet.",
      noAwards: "No awards exist for this contract yet.",
      noDocuments: "No documents are currently linked to this contract.",

      customer: "Customer / Company",
      contractNumber: "Contract Number",
      mode: "Competition Type",
      unitType: "Unit Type",
      ...
      totalBids: "Submitted Bids",
      totalLotQuantity: "Total Lot Quantity",
      totalBidValue: "Total Bid Value",

      company: "Company",
      lot: "Competition",
      fullContract: "Full Contract",
      unitPrice: "Unit Price",
      totalPrice: "Total",
      executionDays: "Execution Period",
      ...
      modeFull: "Full Contract",
      modeSplit: "Split into Lots",
            pageSubtitle: "Manage commercial contracts, launch competitions, review bids and manage awards.",
      close: "Close",
      search: "Search",
      searchPlaceholder: "Contract number, name or customer",
      ...
      draftNotice: "The contract will be created as a draft and will not be available to companies until published.",

      contractTitle: "Contract Name",
      contractNumberLabel: "Contract Number",
      contractNumberPlaceholder: "Generated automatically when left blank",
      customerName: "Company / Customer Name",
      customerId: "Customer ID (Optional)",
      competitionMethod: "Competition Method",
      unitsLabel: "Number of Units",
      unitTypePlaceholder: "Container, shipment, cargo...",
      shipmentType: "Shipment Type",
      requiredCapacity: "Required Capacity",
      targetContractValue: "Target Contract Value",
      executionStart: "Execution Start Date",
      executionEnd: "Execution End Date",
      biddingDeadlineLabel: "Bid Submission Deadline",
      ...
      unitsPositive: "Number of units must be greater than zero",
      ...
      messages: {
        publishSuccess: "The contract has been published for competition.",
        reviewSuccess: "The contract has been moved to review.",
        cancelSuccess: "The contract has been cancelled.",
        bidReviewSuccess: "The bid status has been updated.",
        shortlistSuccess: "The bid has been shortlisted.",
        rejectSuccess: "The bid has been rejected.",
      },
