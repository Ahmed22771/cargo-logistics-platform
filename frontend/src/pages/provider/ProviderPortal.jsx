...
import ProviderContracts from "./ProviderContracts";
...
const NAV = [
  ...
  },
  {
    key: "available",
    to: "/available",
    label: "provider.availableShipments",
    icon: Package,
  },
  {
    key: "offers",
  ...
  },
  {
    key: "contracts",
    to: "/contracts",
    label: "adminContracts.title",
    icon: FileText,
  },
  {
    key: "trips",
    to: "/trips",
    label: "provider.trips",
    icon: Truck,
  },
  {
    key: "messages",
  ...
  },
  {
    key: "documents",
    to: "/documents",
    label: "provider.companyDocs",
    icon: FileText,
  },
  {
    key: "profile",
    to: "/profile",
    label: "provider.companyProfile",
    icon: Building2,
  },
];
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path="vehicles/:id"
          element={<ProviderVehicleDetail />}
        />

        <Route
          path="drivers"
          element={<ProviderDrivers />}
        />

        <Route
          path="drivers/:id"
          element={<ProviderDriverDetail />}
        />
        ...
        <Route
          path="finance"
          element={<ProviderFinance />}
        />

        <Route
          path="messages"
          element={<Messages basePath="/provider" />}
        />
